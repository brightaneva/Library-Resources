...
#To increase the number of search result.
#the quote fuction and change the limit parameter to required number
...
def quote(search, limit=10) -> Optional[List[Dict[str, str]]]:
    """\
